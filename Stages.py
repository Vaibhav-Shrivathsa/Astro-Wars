...
class IndestructableBlock:
    ...
    def __init__(self, center, size):
        ...
        self.collider = CollisionDetection.Rectangle(center - reflected_size / 2, center + reflected_size / 2)
...
class OuterBoundary:
    ...
    def __init__(self, center, size):
        ...
        self.size = size
        reflected_size = Vector2(size[0], -size[1])
        self.collider = CollisionDetection.InvertedRectangle(center - reflected_size / 2, center + reflected_size / 2)
...
basic_destructable_blocks = [DestructableBlock(Vector2(6.5, 0), Vector2(1, 1)),
                             ...
                             DestructableBlock(Vector2(-4.5, 0), Vector2(1, 1)),
                             DestructableBlock(Vector2(-3.5, 0), Vector2(1, 1))]
basic_indestructable_blocks = [IndestructableBlock(Vector2(0, 0), Vector2(6, 1)),
...
Stages.BASIC = Stage(basic_destructable_blocks, basic_indestructable_blocks, basic_outer_boundary)
